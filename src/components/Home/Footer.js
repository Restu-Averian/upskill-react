...
function Footer(props) {
  const footerData = [
    {
      title: "Company",
      data: ["About Us", "Press Release", "Terms of Use", "Privacy & Policy"],
    },
    {
      title: "Support",
      data: ["Refund Policy", "Unlock Rewards", "Live Chatting"],
    },
    {
      title: "Connect",
      data: [
  ...
  const supportData = ["Refund Policy", "Unlock Rewards", "Live Chatting"];
  const connectData = [
    "hi@store.gg",
    "team@store.gg",
    "Pasific 12, Jakarta Selatan",
          ...
          <div className="col-lg-8 mt-lg-0 mt-20">
            <div className="row gap-sm-0">
              {footerData.map((foot) => {
                return (
                  <Fragment key={foot}>
                    <FooterComp data={foot.data} title={foot.title} />
                  </Fragment>
                );
              })}
            </div>
